        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredCategoryId = table.Column<int>(type: "INTEGER", nullable: true),
                    DisplayCategoryId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Students_Categories_DisplayCategoryId",
                        column: x => x.DisplayCategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Students_Categories_PreferredCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldPhotosJson = table.Column<string>(type: "TEXT", nullable: true),
                    NewPhotosJson = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProposedChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProposedChanges_AspNetUsers_ProposedByUserId",
                        column: x => x.ProposedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProposedChanges_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_UserId_StudentId",
                table: "Likes",
                columns: new[] { "UserId", "StudentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProposedChanges_ProposedByUserId",
                table: "ProposedChanges",
                column: "ProposedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProposedChanges_StudentId",
                table: "ProposedChanges",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_DisplayCategoryId",
                table: "Students",
                column: "DisplayCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_PreferredCategoryId",
                table: "Students",
